...
final class ptyx_string extends ffi.Struct {
  ...
  static ffi.Pointer<ptyx_string> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Char> data,
    required int len,
  }) => $allocator<ptyx_string>()
    ..ref.data = data
    ..ref.len = len;
}
...
final class ptyx_term_mode extends ffi.Struct {
  ...
  static ffi.Pointer<ptyx_term_mode> $allocate(
    ffi.Allocator $allocator, {
    required int valid_fields,
    required bool canonical,
    required bool echo,
    required bool signals,
  }) => $allocator<ptyx_term_mode>()
    ..ref.valid_fields = valid_fields
