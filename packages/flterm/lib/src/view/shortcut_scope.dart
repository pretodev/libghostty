...
@internal
final class ClearIntent extends Intent {
  const ClearIntent();
}

/// Copy the current terminal selection.
@internal
final class CopyIntent extends Intent {
  const CopyIntent();
}
...
@internal
final class SelectAllIntent extends Intent {
...
final class _ConditionalAction<T extends Intent> extends Action<T> {
